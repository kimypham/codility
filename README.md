...
| 10 | [MissingInteger](10-missingInteger.ts)  | Calculate the values of counters after applying all alternating operations: increase counter by 1; set value of all counters to current maximum.  |  Medium  |  O(n)  |  [Report](https://app.codility.com/demo/results/trainingQW529W-4DW/) |